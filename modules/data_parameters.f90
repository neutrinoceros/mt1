...
real(8),parameter :: STEP = 1.D0    ! should be tested with 1/20 * (shorter period (Moon, or alternatively Mercury))
                                    ! for the moon it would give STEP = 30./20. = 1.5 (day)
real(8),parameter :: TMAX = 1800    ! should be tested for a hundred years (3.65e4 days)
